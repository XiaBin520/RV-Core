...
void VtestScala___024root__traceChgSub0(VtestScala___024root* vlSelf, VerilatedVcd* tracep);
...
void VtestScala___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        VtestScala___024root__traceChgSub0((&vlSymsp->TOP), tracep);
    }
}
...
void VtestScala___024root__traceChgSub0(VtestScala___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+2,(vlSelf->io_a),3);
        tracep->chgCData(oldp+3,(vlSelf->io_out),4);
    }
}
