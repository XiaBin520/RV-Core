...
class decoderIO extends Bundle{
  ...
  val aluWEn      = Output(Bool())
  val aluWOP      = Output(UInt(3.W))
...
class decoder extends Module{
  ...
  val aluWEn = WireDefault(false.B)
  val aluWOP = WireDefault(opWNone)
  ...
  switch(opcode){
    ...
    is("b0011011".U){
      ...
      rs1REn := true.B
      switch(funct3){
        is("b000".U) {aluWOP := opWAdd}
        is("b001".U) {aluWOP := opWLShift}
        is("b101".U) {
    ...
    is("b0111011".U){
      ...
      switch(funct3){
        is("b000".U){
          switch(funct7){
            is("b0000000".U) {aluWOP := opWAdd}
            is("b0100000".U) {aluWOP := opWSub}
          }
        }
        is("b001".U){
          switch(funct7){
            is("b0000000".U) {aluWOP := opWLShift}
          }
        }
        is("b101".U){
          switch(funct7){
            is("b0000000".U) {aluWOP := opWURShift}
            is("b0100000".U) {aluWOP := opWSRShift}
          }
        }
      }
    }
